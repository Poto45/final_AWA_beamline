...
vertices = []
numVertices = [74, 74, 74, 74, 74, 74, 74, 74, 74, 74, 74, 74, 74, 74, 74, 74, 74, 74]
vertices_base64 = ""
...
def exportVTK():
    ...
    fh = open('input_ElementPositions.vtk','w')
...
def exportWeb(bgcolor):
    ...
    fh = open('input_ElementPositions.html','w')
    fh.write(index)
    fh.close()
...
def projectToPlane(normal):
    fh = open('input_ElementPositions.gpl','w')
