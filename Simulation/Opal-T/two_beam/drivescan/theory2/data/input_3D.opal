...
DistFT: DISTRIBUTION, TYPE = FLATTOP,        SIGMAX = SigmaLaser,          SIGMAY = SigmaLaser,  
        TRISE = 300e-15/2.35*1.6869,               TFALL = 300e-15/2.35*1.6869,         OFFSETT = -2.1000000000000002e-11,        TPULSEFWHM = 6e-12,         CUTOFFLONG = 4.0,        NBIN = BINS,        EMISSIONSTEPS = 200,        EMISSIONMODEL = ASTRA,        EKIN = 0.55,                   EMITTED = True,                WRITETOFILE = True;
